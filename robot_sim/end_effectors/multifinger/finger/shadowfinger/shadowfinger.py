...
import robot_sim.end_effectors.multifinger.finger.finger_interface as fi

class Shadowfinger(fi.FingerInterface):

    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(4), name='ur3e', enable_cc=True):
        super().__init__(pos=pos, rotmat=rotmat, name=name)
        this_dir, this_filename = os.path.split(__file__)

        self.jlc = jl.JLChain(pos=pos, rotmat=rotmat, homeconf=homeconf, name=name)
        self.jlc.jnts[1]['loc_pos'] = np.array([0.033, 0, 0.095])
        ...
        self.jlc.jnts[3]['loc_pos'] = np.array([0, 0, 0.045])
        self.jlc.jnts[3]['loc_motionax'] = np.array([1, 0, 0])

        self.jlc.jnts[4]['loc_pos'] = np.array([0, 0, 0.025])
        ...
        self.jlc.lnks[0]['mesh_file'] = os.path.join(this_dir, "meshes", "palm.dae")
        self.jlc.lnks[0]['rgba'] = [.5, .5, .5, 1.0]
        self.jlc.lnks[0]['scale'] = [.001, .001, .001]

        self.jlc.lnks[1]['name'] = "ffknuckle"
        self.jlc.lnks[1]['loc_pos'] = np.array([0, 0, 0.0005])
        self.jlc.lnks[1]['mass'] = 2.0
        self.jlc.lnks[1]['mesh_file'] = os.path.join(this_dir, "meshes", "knuckle.dae")
        self.jlc.lnks[1]['rgba'] = [.5, .5, .5, 1.0]
        self.jlc.lnks[1]['scale'] = [.001, .001, .001]

        self.jlc.lnks[2]['name'] = "ffproximal"
        self.jlc.lnks[2]['loc_pos'] = np.array([0, 0, 0])
        self.jlc.lnks[2]['mass'] = 2.0
        self.jlc.lnks[2]['mesh_file'] = os.path.join(this_dir, "meshes", "F3.dae")
        self.jlc.lnks[2]['rgba'] = [.5, .5, .5, 1.0]
        self.jlc.lnks[2]['scale'] = [.001, .001, .001]

        self.jlc.lnks[3]['name'] = "ffmiddle"
        self.jlc.lnks[3]['loc_pos'] = np.array([0, 0, 0])
        self.jlc.lnks[3]['mass'] = 2.0
        self.jlc.lnks[3]['mesh_file'] = os.path.join(this_dir, "meshes", "F2.dae")
        self.jlc.lnks[3]['rgba'] = [.5, .5, .5, 1.0]
        self.jlc.lnks[3]['scale'] = [.001, .001, .001]

        self.jlc.lnks[4]['name'] = "ffdistal"
        self.jlc.lnks[4]['loc_pos'] = np.array([0, 0, 0])
        self.jlc.lnks[4]['mass'] = 2.0
        self.jlc.lnks[4]['mesh_file'] = os.path.join(this_dir, "meshes", "F1.dae")
        self.jlc.lnks[4]['rgba'] = [.5, .5, .5, 1.0]
        self.jlc.lnks[4]['scale'] = [.001, .001, .001]
...
if __name__ == '__main__':
    ...
    manipulator_instance = Shadowfinger(enable_cc=True)
    ...
    gm.gen_frame(length=0.1).attach_to(base)
    base.run()